...
const DUO_CARD_STEPS = ['bootstrap','org_setup','authproxy_push','ad_sync','saml_scim_config','authproxy_enroll','scim_push','sso_saml','sso_authsource','mfa_policy','sso_test','verify'];
